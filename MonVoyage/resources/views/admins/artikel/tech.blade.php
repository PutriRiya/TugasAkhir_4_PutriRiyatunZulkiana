...
<html lang="en">
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="assetartikel/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="assetartikel/images/apple-touch-icon.png">
    
    <!-- Design fonts -->
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet"> 

    <!-- Bootstrap core CSS -->
    <link href="assetartikel/css/bootstrap.css" rel="stylesheet">

    <!-- FontAwesome Icons core CSS -->
    <link href="assetartikel/css/font-awesome.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="assetartikel/style.css" rel="stylesheet">

    <!-- Responsive styles for this template -->
    <link href="assetartikel/css/responsive.css" rel="stylesheet">

    <!-- Colors for this template -->
    <link href="assetartikel/css/colors.css" rel="stylesheet">

    <!-- Version Tech CSS for this template -->
    <link href="assetartikel/css/version/tech.css" rel="stylesheet">
...
<body>
                            ...
                            <div class="blog-list clearfix">
                                    ...
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="assetartikel/upload/tech_blog_01.jpg" alt="" class="img-fluid">
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="tech-single.html" title="">
                                                <img src="assetartikel/upload/tech_blog_02.jpg" alt="" class="img-fluid">
                                                <div class="hovereffect"></div>
                                            </a>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
    ...
    <!-- Core JavaScript
    ================================================== -->
    <script src="assetartikel/js/jquery.min.js"></script>
    <script src="assetartikel/js/tether.min.js"></script>
    <script src="assetartikel/js/bootstrap.min.js"></script>
    <script src="assetartikel/js/custom.js"></script>
